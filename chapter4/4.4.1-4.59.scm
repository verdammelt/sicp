...
;; habit of forgetting meetings could cost him his job, Ben decides to
;; do something about it. He adds all the weekly meetings of the firm
;; to the Microshaft data base by asserting the following:
;;     (meeting accounting (Monday 9am))
;;     (meeting administration (Monday 10am))
;;     (meeting computer (Wednesday 3pm))
;;     (meeting administration (Friday 1pm))
;; Each of the above assertions is for a meeting of an entire
;; division. Ben also adds an entry for the companywide meeting that
;; spans all the divisions. All of the company's employees attend this
;; meeting.
...
;; more useful to be able to ask for her meetings by specifying her
;; name. So she designs a rule that says that a person's meetings
;; include all whole-company meetings plus all meetings of that
...
(rule (meeting-time ?person ?day-and-time)
      (and (meeting ?division ?day-and-time)
	   (or (same ?division whole-company)
